#!/usr/bin/env python3
"""Reference implementation for the realistic childcare expansion model.

Notebook 05 and Notebook 06 are now the canonical Part 2 source of truth.
This script is retained as a reference backup of the repaired pipeline that was
ported back into the notebooks.

The implementation documents two concrete repairs:
