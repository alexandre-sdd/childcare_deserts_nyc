...
\Cref{fig:realistic-expansion-functions} visualizes these implemented Part 2 expansion functions. The left panel shows the staircase caps created by cumulative floors, and the right panel shows how the block-specific per-slot coefficients decrease with facility size.
